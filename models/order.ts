...
// Add these fields to the Order interface
export interface Order {
  ...
  currency_code: string | null; // Added for currency support
  currency_rate: number | null; // Added for
  created_at: Date;
  updated_at: Date;
}
...
export const createOrderFromCart = async (
  orderData: {
    ...
    shipping_method: string;
    payment_method: string;
    currency_code?: string; // Added for currency support
    currency_rate?: number; // Added for currency support
  },
